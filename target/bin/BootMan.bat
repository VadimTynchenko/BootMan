...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="BootMan" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.vadimtynchenko.bootman.BootManApp %CMD_LINE_ARGS%
